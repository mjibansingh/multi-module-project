...
public class VerificationToken extends Auditable {
    ...
    private static final int EXPIRATION = 5; //set expiry time with 5 minutes
	...
	public VerificationToken(User user, String token, String otp) {
		super();
		this.user = user;
		this.token = token;
		this.otp = otp;
		this.expiryDate = calculateExpiryDate(EXPIRATION);
		this.status = TokenStatus.GENERATED.toString();
	}
